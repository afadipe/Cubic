...
using Cubic.Data.EntityConfiguration;
...
namespace Cubic.Data
{
    ...
    public class APPContext : DbContext
    {
        ...
        public APPContext(DbConnection existingConnection) : base(existingConnection, false)
        {

        }

        public APPContext(DbConnection existingConnection, bool contextOwnsConnection)  : base(existingConnection, contextOwnsConnection)
        {
